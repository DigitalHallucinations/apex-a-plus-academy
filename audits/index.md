...
The first additional track (Network+, `003`) has shipped. The next track-related
audit is the second additional certification (Security+, `004`):

```text
AUDIT-YYYY-MM-DD-security-plus-starter
```

Type: `content` plus `implementation`.
